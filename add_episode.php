...
<body class="antialiased">
    <div class="container mx-auto px-6 py-12">
        ...
        <form method="GET" action="add_episode.php" class="mb-8">
        ...
        <?php if ($selected_season_id > 0): ?>
            ...
            <?php if (!empty($episodes)): ?>
                <form action="add_episode.php?tmdb_id=<?php echo htmlspecialchars($tmdb_id); ?>&season_id=<?php echo htmlspecialchars($selected_season_id); ?>" method="POST">
                        ...
                        <table class="min-w-full bg-gray-800 rounded-lg">
                            <thead>
                                <tr>
                                    ...
                                    <th class="py-3 px-6 bg-gray-700 text-left text-xs font-semibold text-gray-300 uppercase tracking-wider">Nombre del Episodio</th>
                                    <th class="py-3 px-6 bg-gray-700 text-left text-xs font-semibold text-gray-300 uppercase tracking-wider">Descripción</th>
                                    <th class="py-3 px-6 bg-gray-700 text-left text-xs font-semibold text-gray-300 uppercase tracking-wider">Enlaces de Reproducción</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php foreach ($episodes as $episode): ?>
                                    <tr class="border-t border-gray-700">
                                        ...
                                        <td class="py-4 px-6"><?php echo htmlspecialchars($episode['episode_name']); ?></td>
                                        <td class="py-4 px-6 text-sm text-gray-400"><?php echo htmlspecialchars($episode['episode_description']); ?></td>
                                        <td class="py-4 px-6">
